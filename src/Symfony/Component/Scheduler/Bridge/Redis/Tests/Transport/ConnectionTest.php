...
final class ConnectionTest extends TestCase
{
    public function testConnectionCannotBeCreatedWithInvalidListName(): void
    {
        ...
        new Connection(['host' => 'localhost', 'auth' => 'root', 'list' => 'foo'], $serializer, $redis);
    }
    ...
    public function testConnectionCannotBeCreatedWithInvalidCredentials(): void
    {
        ...
        new Connection(['host' => 'localhost', 'auth' => 'root', 'dbindex' => 'test'], $serializer, $redis);
    }
    ...
    public function testConnectionCannotListWithException(): void
    {
        ...
        $connection = new Connection(['host' => 'localhost', 'auth' => 'root'], $serializer, $redis);
    ...
    public function testConnectionCanCreate(string $list): void
    {
        ...
        $connection = new Connection(['host' => 'localhost', 'auth' => 'root', 'list' => $list], $serializer, $redis);
        $connection->create($taskToCreate);
    }
    ...
    public function testConnectionCannotGetUndefinedTask(): void
    {
        ...
        $connection = new Connection(['host' => 'localhost', 'auth' => 'root', 'port' => 6379], $serializer, $redis);
