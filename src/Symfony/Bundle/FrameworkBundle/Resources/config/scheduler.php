...
return static function (ContainerConfigurator $container): void {
    $container->services()
        ...
        ->set('scheduler.transport_factory.fail_over', FailoverTransportFactory::class)
            ->args([
                tagged_iterator('scheduler.transport_factory'),
            ])
            ->tag('scheduler.transport_factory')

        ->set('scheduler.transport_factory.long_tail', LongTailTransportFactory::class)
            ->args([
                tagged_iterator('scheduler.transport_factory'),
            ])
            ->tag('scheduler.transport_factory')

        ->set('scheduler.transport_factory.round_robin', RoundRobinTransportFactory::class)
            ->args([
                tagged_iterator('scheduler.transport_factory'),
            ])
            ->tag('scheduler.transport_factory')
